...
class InquiryViewController: UIViewController {
    ...
    private let phoneButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(copyPhone), for: .touchUpInside)
        return button
    }()
    ...
    private let cancelButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(dismissView), for: .touchUpInside) // Correct target to self
        button.layer.cornerRadius = 14
        return button
    }()
